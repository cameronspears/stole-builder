...
import { EmbroideryHoop } from "@/components/svg/EmbroideryHoop";
import { useStoleStore } from "@/lib/store";
import { FONT_OPTIONS } from "@/lib/constants";
import type { FontPreferenceId } from "@/lib/types";

interface EmbroideryFormItemProps {
  onClick: () => void;
  isActive: boolean;
}

export function EmbroideryFormItem({ onClick, isActive }: EmbroideryFormItemProps) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-pegboard mb-2">
        Add custom embroidery to your stole:
      </p>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:border-amber-500 focus:ring-1 focus:ring-amber-500 outline-none"
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:border-amber-500 focus:ring-1 focus:ring-amber-500 outline-none bg-white"
        >
