...
import { ThreadSpool } from "@/components/svg/ThreadSpool";
...
interface AccentToolItemProps {
  onClick: () => void;
  isActive: boolean;
}

export function AccentToolItem({ onClick, isActive }: AccentToolItemProps) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-pegboard mb-2">
        Choose your accent metal and trim style:
      </p>
